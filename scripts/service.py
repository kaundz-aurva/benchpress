...
proc benchpress_env {{name default}} {{
...
set virtual_users [benchpress_env "BENCHPRESS_VIRTUAL_USERS" "{runtime_spec.workload.virtual_user_ladder[0]}"]
set warmup_minutes [benchpress_env "BENCHPRESS_WARMUP_MINUTES" "{timing.warmup_minutes}"]
set measured_minutes [benchpress_env "BENCHPRESS_MEASURED_MINUTES" "{timing.measured_minutes}"]
set cooldown_minutes [benchpress_env "BENCHPRESS_COOLDOWN_MINUTES" "{timing.cooldown_minutes}"]
